...
class BasePage(Page):
    ...
    def close_payments_popup(self):
        """Close the payments popup if it's present and visible."""
        try:
            popover = self.find_element(*self.PAYMENTS_POPUP)
    ...
    class Footer(Region):
        ...
        def select_language(self, value):
            ...
            # because the payments popover obscures it.
            self.page.close_payments_popup()
            language_select = self.find_element(*self._language_locator)
